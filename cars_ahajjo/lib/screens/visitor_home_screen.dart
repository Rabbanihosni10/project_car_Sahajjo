  ...
  final List<Map<String, String>> _carParts = [
    {
      ...
      'brand': 'Toyota',
      'rating': '4.5',
      'image': 'https://placehold.co/200x200/3498db/ffffff?text=Oil+Filter',
    },
    {
      'name': 'Brake Pads Set',
      'price': '৳2,500',
      'brand': 'Honda',
      'rating': '4.7',
      'image': 'https://placehold.co/200x200/e74c3c/ffffff?text=Brake+Pads',
    },
    {
      'name': 'Air Filter',
      'price': '৳350',
      'brand': 'Suzuki',
      'rating': '4.3',
      'image': 'https://placehold.co/200x200/2ecc71/ffffff?text=Air+Filter',
    },
    {
      'name': 'Spark Plugs',
      'price': '৳800',
      'brand': 'Universal',
      'rating': '4.6',
      'image': 'https://placehold.co/200x200/f39c12/ffffff?text=Spark+Plugs',
    },
  ];
  ...
  final List<Map<String, String>> _carsForSale = [
    {
      ...
      'mileage': '45,000 km',
      'rating': '4.8',
      'image': 'https://placehold.co/300x200/34495e/ffffff?text=Toyota+Corolla',
    },
    {
      ...
      'mileage': '38,000 km',
      'rating': '4.7',
      'image': 'https://placehold.co/300x200/16a085/ffffff?text=Honda+Civic',
    },
    {
      ...
      'mileage': '25,000 km',
      'rating': '4.6',
      'image': 'https://placehold.co/300x200/c0392b/ffffff?text=Suzuki+Swift',
    },
  ];
